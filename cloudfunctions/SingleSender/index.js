...
// 短信应用SDK AppID
// SDK AppID是1400开头，此处为示例SDKAppID
var sdkappid = '1400009099';

// 短信应用SDK AppKey
// APPKey是随机的32位秘钥，需在控制台进行查看，此处为示例Appkey
var appkey = '9ff91d87c2cd7cd0ea762f141975d1df37481d48700d70ac37470aefc60f9bad';

// 短信模板ID，需要在短信应用中申请。
// 这里的模板ID`7839`只是一个示例，真实的模板ID需要在短信控制台中申请
// 注意！此示例Demo需要申请使用模板内容为：{1}为您的验证码，请在5分钟内填写。
var templateId = '7839';  
...
var random = Math.round(Math.random()*899998+100000);
 ...
 new Promise((resolve, reject) => {
    ...
    request({
      ...
      body: {
        ...
        sig: CryptoJS.SHA256('appkey=' + appkey + '&random=' + random + '&time=' + timestamp + '&mobile=' + event.number).toString(),
        sign: smsSign,
        tel: {
          mobile: event.number,
          nationcode: "86"
